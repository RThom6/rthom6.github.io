export const recentProjects = [
  {
    title: "tello-rust",
    description:
      "Tello-rust was my first small to medium sized project in Rust. It is a wrapper for controlling a DJITello drone using the Ryze Tello sdk. The library works as a wrapper for this SDK and works over a UDP port. The aim of it was to translate DJITelloPy from Python to Rust as a way of learning a bit about a new language. I uploaded version 1.0 of the library to crates.io (the rust community's library registry) on the 14th of September 2024 and by the 19th it had garnered over 350 downloads.",
    description2:
...
export const someInfo = [
  ...
  },
  {
    title: "Reading",
    description:
      "I love engrossing myself in a good book. More recently I've been looking at books on psychology and self improvement/communication but I often indulge in Greek Mythology books.",
  },
  {
    title: "Sports",
    description:
      "I've competed in athletics, participating in the high jump and filling in for other random events. Now I work out regularly, which has taught me goal-setting and self-discipline that I apply to every part of my life.",
  },
  {
  ...
  },
  {
    ...
    description:
      "I've recently finished my Masters in Computer Science. I did it 50% because it's interesting stuff, 30% because I wanted the career opportunities and 20% because a Masters sounds cooler than a Bachelors.",
  },
  {
    title: "Problem Solving",
    description:
      "I love collaborating on creative solutions to technical problems and always aim to think outside the box. Bouncing ideas off my peers is the quickest way to come to a working solution to most things.",
  },
  {
    title: "Mentor and Guide",
    description:
      "I take pride in helping others learn and grow. Whether it's through teaching roles or supporting my friends, I enjoy sharing knowledge and then naturally being handed knowledge by the people I interact with.",
  },
  {
    title: "Driven by Curiosity",
    description:
      "Curiosity fuels everything I do. From exploring new technologies to diving into personal projects, I am always excited to discover how things work and how I can make them better.",
  },
];
