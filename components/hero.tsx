...
const Hero = () => {
  return (
    <div className="pb-20 pt-10">
        ...
        <div className="h-screen w-full dark:bg-black bg-white  dark:bg-grid-white/[0.0] bg-grid-black-100/[0.2] flex items-center justify-center absolute top-0 left-0">
